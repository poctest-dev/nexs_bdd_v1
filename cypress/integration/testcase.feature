Feature: Default
	...
	Scenario: CUC-Enroll a new user subscription even after network disruption
		Given User bought the device and security product at Retail Store Bestbuy Staples Walmart and registers with TechBench services Geeksquad to onboard his device with security product by providing customer information like email address
