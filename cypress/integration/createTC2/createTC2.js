...
Given('User bought the device and security product at Retail Store e.g. Bestbuy, Staples, Walmart and registers with TechBench services e.g. Geeksquad to onboard his device with security product and not willing to provide customer information like email address',async function(){
  cy.visit('http://localhost:53457/swagger/index.html?urls.primaryName=V2')
});


When('Techbench agent initiates Techbench Application to initiate Security Product by calling McAfee Backend B2B APIs by providing Customer and his purchase information like Customer ID, Product ID, Work Order ID and fake email flag',async function(){
  
  var request = JSON.stringify({
    "partnerTransactionId": "qqqwwabbbzzxx",
    "subscriptions": [
      {
        "customerId": "CUST1500-11082020NIK92",
        "emailId": "fakeemail22001301EFG39@dispostable.com",
        "firstName": "EFG39",
        "lastName": "LNEFG39",
        "isFakeEmail": "true",
        "products": [
          {
            ...
            "ExtendedInfo": {
                "clientuniqueId": "DUI349-11082020NIK92"
            }
          }
        ]
      }
